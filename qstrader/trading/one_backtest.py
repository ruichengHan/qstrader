...
from qstrader.exchange.daily_simulated_exchange import DailySimulatedExchange
from qstrader.simulation.daily_bday import DailyBusinessDaySimulationEngine
from qstrader.system.one_qts import OneQuantTradingSystem
...
class OneBacktestTradingSession(TradingSession):
    """
    ...
    def _create_exchange(self):
        ...
        """
        return DailySimulatedExchange(self.start_dt)
